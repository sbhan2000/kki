...
from MatrixMusic.utils import AdminRightsCheck
from MatrixMusic.utils.database import is_active_chat, is_nonadmin_chat
from MatrixMusic.utils.decorators.language import languageCB
from MatrixMusic.utils.inline import close_markup, speed_markup
...
@app.on_message(
    filters.command(["cspeed", "speed", "cslow", "slow", "playback", "الصوت"], prefixes=["/", "!", "%", ",", "", ".", "@", "#"])  
    & ~BANNED_USERS
)
@AdminRightsCheck
