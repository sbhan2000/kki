...
from MatrixMusic.utils.database import get_loop
from MatrixMusic.utils.decorators import AdminRightsCheck
from MatrixMusic.utils.inline import close_markup, stream_markup
...
@app.on_message(
    command(["/skip", "تخطي", "/next", "التالي","skip","next"]) & ~BANNED_USERS
)
@AdminRightsCheck
