...
from MatrixMusic.utils.decorators.admins import ActualAdminCB
from MatrixMusic.utils.decorators.language import language, languageCB
from MatrixMusic.utils.inline.settings import (
    auth_users_markup,
    playmode_users_markup,
    setting_markup,
    vote_mode_markup,
)
from MatrixMusic.utils.inline.start import private_panel
from config import BANNED_USERS, OWNER_ID


@app.on_message(
    filters.command(["الاعدادات", "setting"], prefixes=["/", "!", "%", ",", "", ".", "@", "#"])  & filters.group & ~BANNED_USERS
)
@language
