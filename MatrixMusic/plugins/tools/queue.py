...
from MatrixMusic.utils import ZelzalyBin, get_channeplayCB, seconds_to_min
from MatrixMusic.utils.database import get_cmode, is_active_chat, is_music_playing
from MatrixMusic.utils.decorators.language import language, languageCB
from MatrixMusic.utils.inline import queue_back_markup, queue_markup
...
@app.on_message(
    command(["/queue", "اونلاين", "queue", "/الاغاني", "قائمة الانتظار", "الاغاني"])
    & filters.group
    & ~BANNED_USERS
)
@language
