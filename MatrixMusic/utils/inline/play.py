...
def track_markup(_, user_id, channel, fplay):
    buttons = [
        ...
        [
            ...
            InlineKeyboardButton(text="𝙎𝙩𝙤𝙥", callback_data=f"ADMIN Stop|{chat_id}"),
        ],
        [
            InlineKeyboardButton(
                text="๏ ᴍᴏʀᴇ ๏",
    ...
    buttons  = [
        ...
        [
          ...
          [
            ...
            InlineKeyboardButton(
                text="𝙎𝙩𝙤𝙥", callback_data=f"ADMIN Stop|{chat_id}"
            ),

            InlineKeyboardButton(
                text="𝙎𝙠𝙞𝙥", callback_data=f"ADMIN Skip|{chat_id}"
            ),
        ],
        [
