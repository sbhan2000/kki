...
super_sudoers = [7185538796]

load_dotenv()

# Get this value from my.telegram.org/apps
API_ID = int(getenv("API_ID", 15986212))
API_HASH = getenv("API_HASH", "6c6ac02bc91d512401c09279f4e69837")
...
OWNER_ID = int(getenv("OWNER_ID", 7185538796))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/Darksourcebot/REVO_MUSIC",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/QR_KR")
